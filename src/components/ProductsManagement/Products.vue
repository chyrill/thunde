...
export default {
  ...
  methods: {
    ...
    submitFeature () {
      ...
      axios({
        method: 'post',
        url: 'http://localhost:3001/api/v1/specification',
        data: valueData,
        headers: {
    ...
    deleteitem () {
      if (this.deleteMode === 1) {
        axios({
        method: 'delete',
        url: 'http://localhost:3001/api/v1/category/' + this.deleteItemId,
        headers: {
          'Authorization' : 'Bearer '+ this.$store.getters.getAuthCode
        }
      }).
        ...
        axios({
        method: 'delete',
        url: 'http://localhost:3001/api/v1/specification/' + this.deleteItemId,
        headers: {
          'Authorization' : 'Bearer '+ this.$store.getters.getAuthCode
        }
      }).
